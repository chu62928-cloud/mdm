...
用法：
    python -m new.analyze_pelvis_tilt --data-dir dataset/HumanML3D --split train
    python -m new.analyze_pelvis_tilt --data-dir dataset/HumanML3D --split train --max-clips 100
    python -m new.analyze_pelvis_tilt --data-dir dataset/HumanML3D \\
